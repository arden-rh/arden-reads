<script lang="ts">
	...
	const booksByMonth = $derived(countBooksByMonth(listOfBooks));
</script>

<div
	class="chart min-h-62.5 w-full max-w-full flex flex-col items-center gap-2 lg:p-4 xl:p-8 border-b-4 lg:border-b-0 lg:border-r-4"
>
