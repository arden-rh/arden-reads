...
<div class="chart min-h-[250px] w-full max-w-full flex flex-col items-center justify-center gap-2 mt-4 lg:mt-0 lg:p-4 xl:p-6 {bottomBorder ? 'border-b-4 lg:border-b-0 lg:border-r-4' : ''}">
	...
	/>
	<div class="w-full xl:max-w-[300px] flex flex-col text-sm grow lg:min-h-[80px] xl:min-h-[60px] xl:max-h-[60px] overflow-y-visible">
